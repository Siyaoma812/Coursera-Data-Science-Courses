...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan 13 16:59:50 2018
...
#used with this API.
#To call the API, you need to provide address that you are requesting as the address= 
#parameter that is properly URL encoded using the urllib.urlencode() fuction as shown 
